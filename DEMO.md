...
- **Blockchain Tx Hash** — the Ethereum transaction hash from the `registerProperty()` call. Paste this into Base Sepolia Basescan to show the on-chain event.
